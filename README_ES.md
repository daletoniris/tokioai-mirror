...
Mas alla del codigo, TokioAI lleva una filosofia. El repositorio [Niperia Lab](https://github.com/daletoniris/niperialab) contiene **78 ensayos, poemas y reflexiones curadas** del fundador — extraidas de las historias destacadas de Instagram de [@niperialab](https://instagram.com/niperialab).
...
**[Leer la coleccion completa →](https://github.com/daletoniris/niperialab)**
